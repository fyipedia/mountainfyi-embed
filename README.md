...
Embed [MountainFYI](https://mountainfyi.com) widgets on any website with [mountainfyi-embed](https://widget.mountainfyi.com):

```html
<script src="https://cdn.jsdelivr.net/npm/mountainfyi-embed@1/dist/embed.min.js"></script>
<div data-mountainfyi="entity" data-slug="example"></div>
```

Zero dependencies · Shadow DOM · 4 themes (light/dark/sepia/auto) · [Widget docs](https://widget.mountainfyi.com)
